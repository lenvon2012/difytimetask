...
### 1. 插件依赖 Godcmd 认证
本插件需要结合 **Godcmd 认证** 使用。只有通过认证的管理员用户才能使用插件的功能。请确保在 `global_config` 中正确配置管理员用户列表。
...
![取消所有任务](./images/取消所有任务_20250114094623.png) ![延时群任务](./images/延时群任务_20250114094258.png)
